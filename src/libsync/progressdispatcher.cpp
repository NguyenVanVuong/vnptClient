...
QString Progress::asResultString( const SyncFileItem& item)
{
    ...
    case CSYNC_INSTRUCTION_TYPE_CHANGE:
        if (item._direction != SyncFileItem::Up) {
            return QCoreApplication::translate( "progress", "Đã tải xuống");
        } else {
            return QCoreApplication::translate( "progress", "Đã tải lên");
        }
    case CSYNC_INSTRUCTION_CONFLICT:
        return QCoreApplication::translate( "progress", "Phiên bản máy chủ đã tải xuống, đã sao chép tệp tin cục bộ đã được thay đổi vào tệp xung đột");
    case CSYNC_INSTRUCTION_REMOVE:
        return QCoreApplication::translate( "progress", "Đã xóa");
    case CSYNC_INSTRUCTION_EVAL_RENAME:
    case CSYNC_INSTRUCTION_RENAME:
        return QCoreApplication::translate( "progress", "Chuyển tới %1").arg(item._renameTarget);
    case CSYNC_INSTRUCTION_IGNORE:
        return QCoreApplication::translate( "progress", "Bỏ qua");
    case CSYNC_INSTRUCTION_STAT_ERROR:
        return QCoreApplication::translate( "progress", "Lỗi truy cập tập tin hệ thống");
    case CSYNC_INSTRUCTION_ERROR:
        return QCoreApplication::translate( "progress", "Lỗi");
    case CSYNC_INSTRUCTION_NONE:
    case CSYNC_INSTRUCTION_EVAL:
        return QCoreApplication::translate( "progress", "Không rõ");
...
QString Progress::asActionString( const SyncFileItem &item )
{
    ...
    case CSYNC_INSTRUCTION_TYPE_CHANGE:
        if (item._direction != SyncFileItem::Up)
            return QCoreApplication::translate( "progress", "Đang tải xuống");
        else
            return QCoreApplication::translate( "progress", "Đang tải lên");
    case CSYNC_INSTRUCTION_REMOVE:
        return QCoreApplication::translate( "progress", "Đang xóa");
    case CSYNC_INSTRUCTION_EVAL_RENAME:
    case CSYNC_INSTRUCTION_RENAME:
        return QCoreApplication::translate( "progress", "Đang chuyển");
    case CSYNC_INSTRUCTION_IGNORE:
        return QCoreApplication::translate( "progress", "Bỏ qua");
    case CSYNC_INSTRUCTION_STAT_ERROR:
        return QCoreApplication::translate( "progress", "Lỗi");

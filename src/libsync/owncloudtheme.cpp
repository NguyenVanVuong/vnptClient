...
{
    return QLatin1String("vnptdrive.cfg");
}

QString ownCloudTheme::about() const
{
    QString devString;
    //devString = trUtf8("<p>Phiên bản %2. Để tìm hiểu nhiều hơn vui lòng truy cập <a href=\"%3\">%4</a></p>"
	...
	devString = trUtf8("<p>Phiên bản %2."
               /*"<p><small>By Klaas Freitag, Daniel Molkentin, Jan-Christoph Borchardt, "
               "Olivier Goffart, Markus Götz and others.</small></p>"
               "<p>Copyright ownCloud GmbH</p>"
               "<p>Licensed under the GNU General Public License (GPL) Version 2.0<br/>"
...
{
    return QString::fromLatin1("https://drive.vnpt.vn/vnptdrive/huong-dan-su-dung-winclient.php").arg(MIRALL_VERSION_MAJOR).arg(MIRALL_VERSION_MINOR);
}

#ifndef TOKEN_AUTH_ONLY
QColor ownCloudTheme::wizardHeaderBackgroundColor() const
{
    return QColor("#0060E0");
}
...
{
    return QLatin1String("VNPT DRIVE");
}

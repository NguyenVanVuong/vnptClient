...
QString Theme::statusHeaderText( SyncResult::Status status ) const
{
    ...
    case SyncResult::Undefined:
        resultStr = QCoreApplication::translate("theme", "Trạng thái chưa biết");
        break;
    case SyncResult::NotYetStarted:
        resultStr = QCoreApplication::translate("theme", "Đang chờ để bắt đầu đồng bộ");
        break;
    case SyncResult::SyncRunning:
        resultStr = QCoreApplication::translate("theme", "Đồng bộ đang chạy");
        break;
    case SyncResult::Success:
        resultStr = QCoreApplication::translate("theme", "Đồng bộ thành công");
        break;
    case SyncResult::Problem:
        resultStr = QCoreApplication::translate("theme", "Đồng bộ thành công, một vài tập tin được bỏ qua.");
        break;
    case SyncResult::Error:
        resultStr = QCoreApplication::translate("theme", "Lỗi đồng bộ");
        break;
    case SyncResult::SetupError:
        resultStr = QCoreApplication::translate("theme", "Lỗi thiết lập" );
        break;
    case SyncResult::SyncPrepare:
        resultStr = QCoreApplication::translate("theme", "Đang chuẩn bị đồng bộ" );
        break;
    case SyncResult::SyncAbortRequested:
        resultStr = QCoreApplication::translate("theme", "Bỏ qua..." );
        break;
    case SyncResult::Paused:
        resultStr = QCoreApplication::translate("theme", "Đồng bộ bị ngừng");
        break;
    }
    return resultStr;
}
...
{
    return QLatin1String("https://drive.vnpt.vn");
}
...
{
    return QLatin1String("http://vnptdata.vn");
}
...
{
    QString re;
	re = tr("<p>Phiên bản %1. </p>").arg(MIRALL_VERSION_STRING);
/*    re = tr("<p>Phiên bản %1. For more information please visit <a href='%2'>%3</a>.</p>")

      ...
      _setupLog()
{
    ...
    setWindowTitle( tr("%1").arg(theme->appNameGUI()));
    setWizardStyle(QWizard::ModernStyle);
    ...
    setButtonText(QWizard::CustomButton1, tr("Bỏ qua cấu hình thư mục"));
    setButtonText(QWizard::BackButton, tr("Quay lại"));
    setButtonText(QWizard::NextButton, tr("Tiếp tục"));
    setButtonText(QWizard::FinishButton, tr("Hoàn tất"));

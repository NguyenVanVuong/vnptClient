    ...
    _ui()
{
    ...
    setTitle(WizardCommon::subTitleTemplate().arg(tr("Mọi thứ đã được thiết lập!")));
    // required to show header in QWizard's modern style
    setSubTitle( QLatin1String(" ") );

    _ui.pbOpenLocal->setText(tr("Mở thư mục trên máy tính"));
    ...
    _ui.pbOpenServer->setText(tr("Mở %1 trong trình duyệt").arg(theme->appNameGUI()));

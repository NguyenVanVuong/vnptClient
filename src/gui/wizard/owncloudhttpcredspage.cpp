    ...
    _progressIndi(new QProgressIndicator (this))
{
    ...
    setTitle(WizardCommon::titleTemplate().arg(tr("Kết nối tới %1").arg(Theme::instance()->appNameGUI())));
    setSubTitle(WizardCommon::subTitleTemplate().arg(tr("Nhập thông tin đăng nhập người dùng")));

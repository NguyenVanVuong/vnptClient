...
#endif
    _ui->_headerLabel->setText(tr("Giao thức đồng bộ trên máy tính"));

    QPushButton *copyBtn = _ui->_dialogButtonBox->addButton(tr("Sao chép"), QDialogButtonBox::ActionRole);
    copyBtn->setToolTip( tr("Sao chép danh sách hoạt động vào khay nhớ tạm."));

    ...
    : QObject(parent)
{
    ...
    if (Utility::isWindows()) {
        ...
        // Example for developer builds (with ad-hoc signing identity): "" "drive.vnpt.vn" ".socketApi"
        // Example for official signed packages: "9B5WD74GWJ." "drive.vnpt.vn" ".socketApi"
...
{
    sendMessage(socket, QLatin1String("SHARE_MENU_TITLE:") + tr("Share with %1", "parameter is VNPT DRIVE").arg(Theme::instance()->appNameGUI()));
}

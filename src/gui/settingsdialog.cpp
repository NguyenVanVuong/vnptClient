    ...
    , _ui(new Ui::SettingsDialog), _gui(gui)
{
    ...
    _ui->setupUi(this);
	_ui->buttonBox->button(QDialogButtonBox::Close)->setText("Đóng"); //vuong1
    ...
    _activityAction = createColorAwareAction(QLatin1String(":/client/resources/activity.png"), tr("Hoạt động"));
    ...
    QAction *generalAction = createColorAwareAction(QLatin1String(":/client/resources/settings.png"), tr("Cài đặt"));
	...
	//Nghia hide
	/*
    QAction *networkAction = createColorAwareAction(QLatin1String(":/client/resources/network.png"), tr("Mạng"));
...
void SettingsDialog::accountAdded(AccountState *s)
{
    ...
    auto accountAction = createColorAwareAction(QLatin1String(":/client/resources/account.png"),
                                                brandingSingleAccount ? tr("Account") : s->account()->displayNameNoHost());
    if (!brandingSingleAccount) {
        accountAction->setToolTip(s->account()->displayNameNoHost());
        accountAction->setIconText(s->shortDisplayNameForSettingsNoHost(height * buttonSizeRatio));
    }

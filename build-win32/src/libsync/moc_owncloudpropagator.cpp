...
QT_MOC_LITERAL(10, 114, 11), // "touchedFile"
QT_MOC_LITERAL(11, 126, 12), // "emitFinished"
QT_MOC_LITERAL(12, 139, 15) // "scheduleNextJob"
    ...
    "touchedFile\0emitFinished\0scheduleNextJob"
};
#undef QT_MOC_LITERAL
...
void OCC::OwncloudPropagator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->touchedFile((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 5: _t->emitFinished(); break;
        case 6: _t->scheduleNextJob(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        ...
        {
            typedef void (OwncloudPropagator::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OwncloudPropagator::touchedFile)) {
                *result = 4;
            }
        }
    }

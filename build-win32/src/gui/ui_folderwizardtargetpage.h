...
public:
    ...
    void retranslateUi(QWidget *FolderWizardTargetPage)
    {
        ...
        groupBox->setTitle(QApplication::translate("FolderWizardTargetPage", "Ch\341\273\215n m\341\273\231t th\306\260 m\341\273\245c \304\221\341\272\277n", 0));
        addFolderButton->setText(QApplication::translate("FolderWizardTargetPage", "T\341\272\241o th\306\260 m\341\273\245c", 0));
        refreshButton->setText(QApplication::translate("FolderWizardTargetPage", "L\303\240m m\341\273\233i", 0));
        QTreeWidgetItem *___qtreewidgetitem = folderTreeWidget->headerItem();
        ___qtreewidgetitem->setText(0, QApplication::translate("FolderWizardTargetPage", "Th\306\260 m\341\273\245c", 0));
    } // retranslateUi

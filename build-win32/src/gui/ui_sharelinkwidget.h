...
public:
    ...
    void setupUi(QWidget *OCC__ShareLinkWidget)
    {
        ...
        pushButton_mail = new QPushButton(widget_shareLink);
        pushButton_mail->setObjectName(QStringLiteral("pushButton_mail"));

        horizontalLayout_3->addWidget(pushButton_mail);
    ...
    {
        OCC__ShareLinkWidget->setWindowTitle(QApplication::translate("OCC::ShareLinkWidget", "Chia s\341\272\273 NewDocument.odt", 0));
        checkBox_shareLink->setText(QApplication::translate("OCC::ShareLinkWidget", "Chia s\341\272\273 li\303\252n k\341\272\277t", 0));
        errorLabel->setText(QApplication::translate("OCC::ShareLinkWidget", "TextLabel", 0));
        pushButton_setPassword->setText(QApplication::translate("OCC::ShareLinkWidget", "Thi\341\272\277t l\341\272\255p &m\341\272\255t kh\341\272\251u ", 0));
        checkBox_expire->setText(QApplication::translate("OCC::ShareLinkWidget", "Thi\341\272\277t l\341\272\255p &ng\303\240y h\341\272\277t h\341\272\241n", 0));
        checkBox_password->setText(QApplication::translate("OCC::ShareLinkWidget", "Thi\341\272\277t l\341\272\255p m\341\272\255t kh\341\272\251u", 0));
        _labelShareLink->setText(QString());
        pushButton_mail->setText(QApplication::translate("OCC::ShareLinkWidget", "&Li\303\252n k\341\272\277t mail", 0));
        pushButton_copy->setText(QApplication::translate("OCC::ShareLinkWidget", "Sao l\306\260u &li\303\252n k\341\272\277t", 0));
        checkBox_editing->setText(QApplication::translate("OCC::ShareLinkWidget", "Cho ph\303\251p ch\341\273\211nh s\341\273\255a", 0));
    } // retranslateUi

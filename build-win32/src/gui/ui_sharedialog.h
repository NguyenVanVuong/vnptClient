...
public:
    ...
    void retranslateUi(QDialog *OCC__ShareDialog)
    {
        ...
        label_name->setText(QApplication::translate("OCC::ShareDialog", "Nh\303\243n chia s\341\272\273", 0));
        label_sharePath->setText(QApplication::translate("OCC::ShareDialog", "\304\220\306\260\341\273\235ng d\341\272\253n Vnpt Drive:", 0));
